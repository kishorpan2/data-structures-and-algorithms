...
const sortPeople = (arr) => {
  // Sort people by their lastnames
  return arr.sort((a, b) => {
    a= a.lastName;
    b= b.lastName;
    if (a===b) return 0;
...
// sort by lastName
// if lastName is the same (and firstName is NOT the same), sort by firstName
// DONE - if lastName and firstName are the same, sort by age
